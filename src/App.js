  ...
  render() {
    return (
      <React.Fragment>
        ...
        <div
          className={`modal ${this.state.modal ? "" : "animated fadeOutUp"}`}
          style={{ display: "" }}
        >
          <div
            className="start-btn"
            ...
            style={{ color: "white", fontSize: "2em", fontFamily: "psn" }}
          >
            Start (no sound)
          </div>
          <div
            ...
            style={{
              ...
              fontSize: "2em",
              fontFamily: "psn",
              display: this.state.ios ? "none" : "flex",
            }}
          >
            Start with sound
          </div>
          <div
            ...
            style={{ color: "white", fontSize: "2em", fontFamily: "psn" }}
          >
            Use left and right arrow keys on keyboard to navigate
          </div>
          <div
            className="animated fadeIn slow"
            style={{ color: "white", fontSize: "2em", fontFamily: "psn" }}
        ...
        <div
          className="App"
          style={{ filter: `blur(${this.state.modal ? "5" : 0}px)` }}
        >
          ...
          <div
            ...
            onClick={() => {
              this.setState(
                { randomNum: null, modal: true, sound: false, ios: true },
                () => {
                  this.getIOS();
                  this.makeRandomNum();
                }
